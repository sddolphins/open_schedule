...
(function(jQuery) {
  ...
  jQuery.fn.calendarView3Day = function() {
  ...
  function build(options) {
    ...
    function render() {
      var startEnd = DateUtils.getBoundaryHoursFromData(opts.data);
  ...
  var Behavior = function(div, opts) {
    ...
    function updateDataAndPosition(div, block, cellWidth, startDate) {
      ...
      jQuery("div.calendarview-block-text", block).text(numberOfHours);
  ...
  var DateUtils = {
    ...
    getBoundaryHoursFromData: function(data) {
